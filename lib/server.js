...
(function() {
  var LogNode, LogServer, LogStream, WebServer, _LogObject, events, express, fs, http, https, io, net, tls, winston,
  ...
  LogServer = (function(superClass) {
    ...
    function LogServer(config) {
      ...
      this.host = config.host, this.port = config.port, this.ssl = config.ssl;
    ...
    LogServer.prototype._createServer = function(config) {
      var options;
      if (config.ssl) {
        options = {
        ...
        this.listener = tls.createServer(options, (function(_this) {
